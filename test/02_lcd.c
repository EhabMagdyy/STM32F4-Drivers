...
int main(){    
    ...
    CLCD_syncInit();
    CLCD_syncWriteCommand(CLCD_0, LCD_CLEAR);
    SYSTICK_DelayMS(2);
    CLCD_syncWriteCommand(CLCD_0, LCD_CURSOR_HOME);
    SYSTICK_DelayMS(2);
    CLCD_syncWriteStringPos(CLCD_0, 1, 4, "Ehab");
    CLCD_syncSaveCustomCharacter(CLCD_0, (uint8_t[]){0x00,0x11,0x0E,0x15,0x15,0x15,0x15,0x04}, 0);
    CLCD_syncWriteCustomCharacter(CLCD_0, 1, 9, 0);
    CLCD_syncWriteStringPos(CLCD_0, 1, 11, "ES46");
