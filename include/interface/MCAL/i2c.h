...
STD_ReturnType I2C_Master_TransmitDMA(const I2C_Config_t* config, uint16_t devAddress, I2C_Buffer_t* buffer);
STD_ReturnType I2C_Master_ReceiveDMA(const I2C_Config_t* config, uint16_t devAddress, I2C_Buffer_t* buffer);
